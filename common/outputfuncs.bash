...
marc4j_jar=$( find_newest_file_matching_pattern_under_directory $solrmarc_lib_dir "marc4j*.jar" )
solrmarc_log_jar=$( find_newest_file_matching_pattern_under_directory $solrmarc_dir/lib "log4j*.jar" )
spreadsheet_jar=$COREDIR/common/spreadsheet_indexer/spreadsheet_indexer.jar
